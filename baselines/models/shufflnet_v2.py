...
def ShuffleNet_v2_x0_5(**kwargs):
    model = ShuffleNetV2(scale=0.5, in_channels = 3, c_tag = 0.5, num_classes = 4, activation = nn.ReLU, SE = False, residual = False, groups = 2)
    return model

def ShuffleNet_v2_x1_0(**kwargs):
    model = ShuffleNetV2(scale=1.0, in_channels = 3, c_tag = 0.5, num_classes = 4, activation = nn.ReLU, SE = False, residual = False, groups = 2)
    return model

def ShuffleNet_v2_x1_5(**kwargs):
    model = ShuffleNetV2(scale=1.5, in_channels = 3, c_tag = 0.5, num_classes = 4, activation = nn.ReLU, SE = False, residual = False, groups = 2)
    return model

def ShuffleNet_v2_x2_0(**kwargs):
    model = ShuffleNetV2(scale=2.0, in_channels = 3, c_tag = 0.5, num_classes = 4, activation = nn.ReLU, SE = False, residual = False, groups = 2)
    return model
