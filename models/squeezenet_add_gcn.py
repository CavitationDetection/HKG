'''
Description: Representation learning (SqueezeNet)+ Graph Convolutional Network (GCN)
Author: Yu Sha
...
class SqueezeNet_ADD_GCN(nn.Module):
    ...
    def __init__(self, model, num_classes, in_channel = 300, tau = 0, eta = 0, adj_file = None):
        super(SqueezeNet_ADD_GCN, self).__init__()
...
# representation learning is SqueezeNet
def squeezenet1_0_add_gcn(num_classes, tau, eta, pretrained = False, adj_file = None, in_channel = 300):
    model = models.squeezenet1_0(pretrained = pretrained)
    return SqueezeNet_ADD_GCN(model, num_classes, tau = tau, eta = eta, adj_file = adj_file, in_channel = in_channel)

def squeezenet1_1_add_gcn(num_classes, tau, eta, pretrained = False, adj_file = None, in_channel = 300):
