...
class DenseNet_ADD_GCN(nn.Module):
    ...
    def __init__(self, model, num_classes, in_channel = 300, tau = 0, eta = 0, adj_file = None):
        super(DenseNet_ADD_GCN, self).__init__()
...
# representation learning is DenseNet
def densenet121_add_gcn(num_classes, tau, eta, pretrained = False, adj_file = None, in_channel = 300):
    model = models.densenet121(pretrained = pretrained)
    return DenseNet_ADD_GCN(model, num_classes, tau = tau, eta = eta, adj_file = adj_file, in_channel = in_channel)

def densenet161_add_gcn(num_classes, tau, eta, pretrained = False, adj_file = None, in_channel = 300):
    model = models.densenet161(pretrained = pretrained)
    return DenseNet_ADD_GCN(model, num_classes, tau = tau, eta = eta, adj_file = adj_file, in_channel = in_channel)

def densenet169_add_gcn(num_classes, tau, eta, pretrained = False, adj_file = None, in_channel = 300):
    model = models.densenet169(pretrained = pretrained)
    return DenseNet_ADD_GCN(model, num_classes, tau = tau, eta = eta, adj_file = adj_file, in_channel = in_channel)

def densenet201_add_gcn(num_classes, tau, eta, pretrained = False, adj_file = None, in_channel = 300):
